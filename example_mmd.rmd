...
equation (GFR (mL/min/1.73 m2) = 175 × (Scr)^-1.154^ × (Age)^-0.203^ ×
(0.742 if female) × (1.212 if African American) in the latter case.
...
BMI below the 10^th^ or above the 90^th^ centile based on data from
NHANES 2015-2016.
...
|-------------------|-------------|-------------|-----|
| 10^th^ percentile | 58          | 155         | 22  |
| 90^th^ percentile | 111         | 182         | 38  |

For data see
<https://wwwn.cdc.gov/nchs/nhanes/continuousnhanes/default.aspx?BeginYear=2015>

We estimate body surface area using the Mosteller equation(10) and use
this to adjust the eGFR as per the NIDDK recommendation (eGFR/1.73m^2^ x
estimated BSA = eGFR).
